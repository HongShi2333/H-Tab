...
window.addEventListener('DOMContentLoaded', function () {
    ...
    function customFile() {
        ...
        Promise.all([
            ...
            .catch(error => {
                MusicPlayer.remove()
                console.error(error)
                alert('请把插件放在网页根目录，否则无法运行【MusicPlayer.js】插件！')
                return
            })
    }
    ...
    function startExecutionPlayer() {
        ...
        function allPlayerFeatures() {
            ...
            const backgroundColors = ['rgba(154, 167, 177, .35)', 'rgba(0, 225, 255, .35)', 'rgba(255, 165, 0, .35)', 'rgba(0, 100, 0, .35)', 'rgba(80, 0, 0, .35)', 'rgba(255, 192, 203, .35)']
            const themeIndex = {
                'xf-original': 0,
                'xf-sky': 1,
                'xf-orange': 2,
    ...
    const message = '不会玩电路的红石'
    const description = 'https://space.bilibili.com/522549816'

    const printStyle = [
        'padding: 5px 10px; border-radius: 5px 0 0 5px; background-color: #9aa7b1; font-weight: bold;',
        'padding: 5px 10px; border-radius: 0 5px 5px 0; background-color: #9aa7b1; font-weight: bold;'
    ]
